...
public record UpdateTaskRequest(string Name, string Description, bool IsCompleted, int ProjectId);

public record CreateSubtaskRequest(int ParentTaskId, string Name, string Description);
public record UpdateSubtaskRequest(string Name, string Description, bool IsCompleted, int ParentTaskId);